...
namespace spore
{
    std::string_view Message::getCommand() const { return command; }
    std::string_view Message::getHandle() const  { return handle;  }
    ...
    void Message::setCommand(std::string_view v) { command = v; }
    void Message::setHandle(std::string_view v)  { handle  = v; }
